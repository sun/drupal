...
abstract class FieldUnitTestBase extends DrupalUnitTestBase {
  ...
  protected function createFieldWithInstance($suffix = '', $entity_type = 'entity_test', $bundle = NULL) {
    ...
    $this->fields->$field_name = drupal_strtolower($this->randomName() . '_field_name' . $suffix);
    ...
    $this->fields->$field_storage_uuid = $this->fields->$field_storage->uuid();
    $this->fields->$instance_definition = array(
    ...
    $this->fields->$instance = entity_create('field_instance_config', $this->fields->$instance_definition);
