...
class ConfigFieldDefinitionTest extends FieldUnitTestBase {
  ...
  public function testBundleFieldDefinition() {
    ...
    $this->assertTrue(isset($definitions[$this->fields->instance->getName()]));
    $this->assertTrue($definitions[$this->fields->instance->getName()] instanceof FieldDefinitionInterface);
    // Make sure no field for the instance on another entity type is exposed.
    $this->assertFalse(isset($definitions[$this->fields->instance_rev->getName()]));
  }
  ...
  public function testFieldStorageDefinition() {
    ...
    $this->assertTrue(isset($field_storage_definitions[$this->fields->instance->getName()]));
    $this->assertTrue($field_storage_definitions[$this->fields->instance->getName()] instanceof FieldStorageDefinitionInterface);
    // Make sure no storage field for the instance on another entity type is
    // exposed.
    $this->assertFalse(isset($field_storage_definitions[$this->fields->instance_rev->getName()]));
  }
